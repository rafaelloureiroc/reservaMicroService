package com.infnetPb.reservaMicroService.controller;
...
import com.infnetPb.reservaMicroService.service.ReservaService;
...
public class ReservaControllerTest {
    ...
    public void testCreateReserva() throws Exception {
        ...
        when(mesaClient.getMesaById(mesaId)).thenReturn(mesaDTO);

        RestauranteDTO restauranteDTO = new RestauranteDTO();
        restauranteDTO.setId(restauranteId);
        when(restauranteClient.getRestauranteById(restauranteId)).thenReturn(restauranteDTO);

        Reserva reserva = new Reserva();
        reserva.setId(reservaId);
        reserva.setMesaId(mesaId);
        reserva.setRestauranteId(restauranteId);
    ...
    public void testCreateReservaFailure() throws Exception {
        ...
        when(mesaClient.getMesaById(mesaId)).thenReturn(new MesaDTO());
        when(restauranteClient.getRestauranteById(restauranteId)).thenReturn(new RestauranteDTO());
